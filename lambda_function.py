...
def lambda_handler(event, context):
    ...
    try:
        ...
        # FIX: Added OwnerIds=['self'] so we only scan OUR snapshots,
        # not all public AWS snapshots (which could cause permission errors on real AWS)
    ...
    print(f"\nNew Snapshots Created: {len(report['snapshots_created'])}")
