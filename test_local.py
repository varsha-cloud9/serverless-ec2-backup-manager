...
def run_local_simulation():
    ...
    # We do this to ensure our deletion report logic works perfectly
    ...
    # Force Moto to pretend this snapshot was created 10 days ago
    # (By default Moto sets creation time to right now)
    fake_past_date = datetime.now(timezone.utc) - timedelta(days=10)
    ec2_client.client_metadata = {} 
